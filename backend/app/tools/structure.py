...
# التعليم العام بيغطي المراحل كلها لحد الثانوية العامة. البكالوريا نظام
# **اختياري** موازي للثانوي — الطالب هو اللي بيختاره، وكتب الوزارة اللي
# بننزّلها كتب التعليم العام، مش كتب بكالوريا.
_LEVELS_FOR_SYSTEM = {
    "egyptGeneral": list(range(-1, 13)),      # رياض أطفال حتى الثانوي
    "egyptBaccalaureate": [10, 11, 12],       # الثانوي بنظام البكالوريا
}
